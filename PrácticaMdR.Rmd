...
Podemos ver como nuestros residuos no cumplen las condiciones necesarias, no siguen una distribución normal. Aun así vamos a comprobar la normalidad y homocedasticidad
...
modelo_yeo_johnson_3 <- lm(x1_trans ~  ISI_trans_2 )
